  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className="flex items-end gap-2 text-xl md:text-2xl font-Ovo mb-3"
      >
        Hi! I'm Jayasurya{" "}
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        <motion.a
          ...
          href="#contact"
          className="px-10 py-3 border border-white rounded-full flex bg-black
